  ...
  return (
    ...
    >
      {entreprises ? (
        <div>
          {console.log(
            entreprises["categorie"]["Numérique"]["reponses"][0][
              "choix_valeur"
            ],
          )}
          ...
          <div className="flex flex-col gap-4 mt-4 text-black w-full">
            <div className="comp flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                Votre entreprise dégage t-elle une part de CA par des produits
            ...
            <div className="flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                La mise en place d’outils numériques a-t-elle permis d'optimiser
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][1][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][2][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][3][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][4][
                        "choix_valeur"
                      ],
                    ]}
                  >
            ...
            <div className="flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                Quel est l’impact du numérique sur la démarche RSE de
                l’entreprise ?
              </h3>
              <Divider className="h-auto" orientation="vertical" />
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][5][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][6][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][7][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][8][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][9][
                        "choix_valeur"
                      ],
                    ]}
                  >
            ...
            <div className="flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                Comment mesurez-vous et exploitez-vous les données issues du
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][11][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][12][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][13][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][14][
                        "choix_valeur"
                      ],
                    ]}
                  >
            ...
            <div className="flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                Comment vous êtes-vous approprié et comment avez-vous accompagné
                ces évolutions?
              </h3>
              <Divider className="h-auto" orientation="vertical" />
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][15][
                        "choix_valeur"
                      ],
                    ]}
                  >
            ...
            <div className="flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                Les nouvelles possibilités technologiques ont-elles fait évoluer
                le modèle d’organisation de l’entreprise et/ou votre management,
                vers plus de collaboration avec des acteurs internes ou externes
                ?
              </h3>
              <Divider className="h-auto" orientation="vertical" />
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][16][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][17][
                        "choix_valeur"
                      ],
                    ]}
                  >
            ...
            <div className="flex flex-row gap-2 h-fit">
              <h3 className="text-default-500 text-lg font-bold">
                Les fonctionnalités des outils sont-elles augmentées par la
                pratique de vos collaborateurs ?
              </h3>
              <Divider className="h-auto" orientation="vertical" />
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][18][
                        "choix_valeur"
                      ],
                    ]}
                  >
              ...
              <div className="flex w-full flex-wrap items-end md::mb-0 gap-4">
                <div className="flex gap-1 w-full flex-row ">
                  <CheckboxGroup
                    ...
                    isReadOnly={true}
                    defaultValue={[
                      entreprises["categorie"]["Numérique"]["reponses"][19][
                        "choix_valeur"
                      ],
                    ]}
                  >
...
export default AxeNumeriqueSynthese;
